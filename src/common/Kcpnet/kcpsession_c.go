...
func (this *KcpClientSession) readMessage() (succ bool) {
	defer func() {
...
func (this *KcpClientSession) WriteMessage(data []byte) (succ bool) {
	...
	//writeCh...
	//Log.FmtPrintln("[client] begin writeCh response message to server, message length: ", len(data))
	_, err := this.conn.Write(data)
	if err != nil {
		Log.FmtPrintln("writeCh data fail, err: ", err)
		return false
	}
